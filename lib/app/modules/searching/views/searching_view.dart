...
class SearchingView extends GetView<SearchingController> {
  ...
  Widget build(BuildContext context) {
    ...
    print(movieC.searchingMovieList.value?.results?.length);
    return Scaffold(
              ...
              children: [
                ...
                Obx(
                  () => Row(
                    ...
                    children: [
                      movieC.searchingMovieList.value == null ||
                              movieC.searchingMovieList.value!.results!.isEmpty
                          ? const SizedBox()
                          : Text(
                              "Page : ${controller.activePage} / ${movieC.searchingMovieList.value?.totalPages}",
                      ...
                      Text(
                        "Results : ${movieC.searchingMovieList.value?.totalResults ?? 0}",
                        style: const TextStyle(
                          color: Colors.white,
                          fontSize: 17,
                        ),
                  ...
                  () => Expanded(
                    child: Column(
                      ...
                      children: [
                        movieC.searchingMovieList.value == null ||
                                movieC
                                    .searchingMovieList.value!.results!.isEmpty
                            ? const Center(
                                child: Text(
                                  "No Results",
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      controller.activePage.value <
                                              movieC.searchingMovieList.value!
                                                  .totalPages!
                                          ? movieC.getSearchingMovie(
                                              controller.searchC.text,
                                              (controller.activePage.value += 1)
